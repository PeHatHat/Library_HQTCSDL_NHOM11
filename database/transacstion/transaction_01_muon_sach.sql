...
BEGIN
    ...
    -- ACTION 2 + 3: Kiểm tra sách và số lượng
    SELECT SoLuongCon
    INTO v_SoLuongCon
    FROM SACH
    ...
    -- ACTION 6: Cập nhật số lượng sách
    UPDATE SACH
    SET SoLuongCon = SoLuongCon - 1
    WHERE MaSach = p_MaSach;

    -- ACTION 7: Xác nhận giao dịch
    COMMIT;
END //
